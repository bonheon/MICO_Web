...
class Detail(models.Model):
    ...
    pre_oper_code2 = models.CharField(max_length=100, verbose_name='Pre Oper Code2', blank=True, default='')
    pre_oper_desc2 = models.CharField(max_length=100, verbose_name='Pre Oper Desc2', blank=True, default='')
    pre_oper_para2 = models.CharField(max_length=100, verbose_name='Pre Oper Para2', blank=True, default='')
    pre_oper_code3 = models.CharField(max_length=100, verbose_name='Pre Oper Code3', blank=True, default='')
    pre_oper_desc3 = models.CharField(max_length=100, verbose_name='Pre Oper Desc3', blank=True, default='')
    pre_oper_para3 = models.CharField(max_length=100, verbose_name='Pre Oper Para3', blank=True, default='')
    pre_oper_code4 = models.CharField(max_length=100, verbose_name='Pre Oper Code4', blank=True, default='')
    pre_oper_desc4 = models.CharField(max_length=100, verbose_name='Pre Oper Desc4', blank=True, default='')
