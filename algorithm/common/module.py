...
class Module_Get:
    ...
    def Module_Get_Pre_VM(merge_df, mico_info_key, pol_type, ai_studio_url=None):
            ...
            for Thk_Para in Thk_Para_List:
                ...
                if ai_studio_url is None:
                    ...
                    if (pre2_df is not None) & (Pre_Oper_Para2 != ''):
                        ...
                        lr = LinearRegression()
                        lr.fit(linear_df[[Pre_Oper_Desc2 + '.' + Pre_Oper_Para2]], linear_df[['Detrend_Thk']])
                        pre_thk_table['PRE_OPER2_b1'] = round(lr.coef_[0][0], 3)
                        pre_thk_table['PRE_OPER2_b0'] = round(lr.intercept_[0], 3)
                    ...
                    if (pre2_df is not None) & (Pre_Oper_Para3 != ''):
                        ...
                        lr = LinearRegression()
                        lr.fit(linear_df[[Pre_Oper_Desc3 + '.' + Pre_Oper_Para3]], linear_df[['Detrend_Thk']])
                        pre_thk_table['PRE_OPER3_b1'] = round(lr.coef_[0][0], 3)
                        pre_thk_table['PRE_OPER3_b0'] = round(lr.intercept_[0], 3)
                    ...
                    if (pre2_df is not None) & (Pre_Oper_Para4 != ''):
                        ...
                        lr = LinearRegression()
                        lr.fit(linear_df[[Pre_Oper_Desc4 + '.' + Pre_Oper_Para4]], linear_df[['Detrend_Thk']])
                        pre_thk_table['PRE_OPER4_b1'] = round(lr.coef_[0][0], 3)
                        pre_thk_table['PRE_OPER4_b0'] = round(lr.intercept_[0], 3)
