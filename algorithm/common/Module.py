   ...
   def Module_Get_Pre_VM(
    ...
    try :
      ...
      for Thk_Para in Thk_Para_List :
        ...
        sigma = 3
        pre_thk_df_merge = pre_thk_df_merge[(pre_thk_df_merge['Detrend_Thk'] <= level_3q + (IQR * sigma)) & (pre_thk_df_merge['Detrend_Thk'] >= level_1q - (IQR * sigma))].copy()

        pre_thk_df_merge = PRE_THK_VM_Get.moving_avg_preiod(pre_thk_df_merge, Pre_Target, Thk_Para, Pre_Thk_Period)
        ...
        if ai_studio_url == None : 
          ...
          if (pre2_df is not None) & (Pre_Oper_Para2 != '') :
            ...
            PRE_OPER2_b0 = round(le.intercept_[0], 3)
          ...
          if (pre2_df is not None) & (Pre_Oper_Para3 != '') :
            ...
            PRE_OPER3_b0 = round(le.intercept_[0], 3)
    ...
    try :
      ...
      for Pre_Thk_Para in Pre_Thk_Para_list : 
        ...
        for i in range(len(pre_thk_table)) : 
          ...
          mongo.insert_row({'Date':today, 'pre_oper_time' : pre_oper_time, 'pre_eq_ch' : pre_eq_ch, 'Pre_Thk' : Pre_Thk,
                            'Count' : Count, 'Pre_THK_Para' : Pre_Thk_Para})
  ...
  def Module_Get_RR(
    ...
    try : 
      ...
      if Pre_Oper_Code == '' : 
        ...
        merge_df_rr = Removal_Rate_Get.Removal_getdata(merge_df, Fab, Lot_Code, Oper_Code, Pre_Oper_Code, Recie_ID, Oper_Desc, Recipe_Info, mico_info_key, ai_studio_url = ai_studio_url)
      ...
      for Thk_Para in Thk_Para_List : 
        ...
        search_key = mico_info_key[(mico_info_key['Thk_Para'] == Thk_Para) & 
    ...
    try : 
      ...
      if Pre_Oper_Code == '' : 
        ...
        for lot_code in Lot_Code_List : 
          merge_df_filter = merge_df[merge_df['Lot_Code'] == lot_code].copy()
          merge_df_temp = Removal_Rate_Get.Removal_getdata(merge_df, Fab, Lot_Code, Oper_Code, Pre_Oper_Code, Recie_ID, Oper_Desc, Recipe_Info, mico_info_key, ai_studio_url = ai_studio_url)
