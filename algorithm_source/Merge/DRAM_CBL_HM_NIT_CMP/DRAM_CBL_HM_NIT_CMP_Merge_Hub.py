...
try :
    ...
    for Lot_Code in Lot_Code_List :
        ...
        for Oper_Code in Oper_Code_List :
            ...
            Lot_Code_List = mico_info_key_r2['Lot_Code'].unique()
            Oper_Code_List = list(mico_info_key_r2['Oper_Code'].unique())
            Pre_Oper_Code = mico_info_key_r2['Pre_Oper_Code'].unique()[0]
            Pre_Oper_Desc = mico_info_key_r2['Pre_Oper_Desc'].unique()[0]
            ...
            Pre_Oper_Code3 = mico_info_key_r2['Pre_Oper_Code3'].unique()[0]
            Pre_Oper_Desc3 = mico_info_key_r2['Pre_Oper_Desc3'].unique()[0]
            Pre_Oper_Para3 = mico_info_key_r2['Pre_Oper_Para3'].unique()[0]
            Pre_Oper_Code4 = mico_info_key_r2['Pre_Oper_Code4'].unique()[0]
            Pre_Oper_Desc4 = mico_info_key_r2['Pre_Oper_Desc4'].unique()[0]
            Pre_Oper_Para4 = mico_info_key_r2['Pre_Oper_Para4'].unique()[0]	
            ...
            for Fab in Fab_List :
                ...
                try :
                    ...
                    Pre_info_df2 = Get_data.PRETHKGetData_MES_HUB(Fab, Lot_Code, Pre_Oper_Code2, Pre_Oper_Para2, Data_lv)
                    Pre_info_df2.columns = map(str.lower, Pre_info_df2.columns)
                    Pre_info_df2.rename(columns={'lot_id' : 'alias_lot_id', 'module_id' : f"{Pre_Oper_Desc2}.{Pre_Oper_Para2}"}, inplace=True)

                    Pre_info_df3 = Get_data.PRETHKGetData_MES_HUB(Fab, Lot_Code, Pre_Oper_Code3, Pre_Oper_Para3, Data_lv)
                    Pre_info_df3.columns = map(str.lower, Pre_info_df3.columns)
                    Pre_info_df3.rename(columns={'lot_id' : 'alias_lot_id', 'module_id' : f"{Pre_Oper_Desc3}.{Pre_Oper_Para3}"}, inplace=True)

                    print(Lot_Code, Fab, Oper_Desc)
                    ...
                    tmp_db = mongodb_controller(db_url, db_name, collection_name)
