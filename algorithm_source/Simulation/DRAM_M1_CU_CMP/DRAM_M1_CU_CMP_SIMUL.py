...
try :
    for product in product_list :
        ...
        for Lot_Code in Lot_Code_List :
            ...
            Oper_Code_List = list(mico_info_filter['Oper_Code'].unique())

            for Oper_Code in Oper_Code_List :
                mico_info_filter2 = mico_info_filter[mico_info_filter['Oper_Code'] == Oper_Code]
                Fab_List = mico_info_filter2['Fab'].unique()
                        ...
                        for i in range(len(search_key_pressure)) :
                            ...
                            if ('EDGE' in Thk_Para) :
                                ...
                                if Simul_Z5.empty :
                                    ...
                                    Simul_Z5 = pd.concat([Simul_Z5, Simul_df])

                    except Exception as e :
                        tb = traceback.format_exc()
                        c.sendMsg('', '506204179', f"{Fab} {Lot_Code} {oper_desc}, Simul Failed : {e}, {tb}")

        Simul_13P.to_csv(f'/project/day/workSpace/mico-platform/mico-platform-mainvs/pjt_shared_pool/{product}_M1_CU_CMP_Simulation/Simul_13P_{product}.csv')
        Simul_EDGE.to_csv(f'/project/day/workSpace/mico-platform/mico-platform-mainvs/pjt_shared_pool/{product}_M1_CU_CMP_Simulation/Simul_ED1_{product}.csv')

        Simul_EXED.to_csv(f'/project/day/workSpace/mico-platform/mico-platform-mainvs/pjt_shared_pool/{product}_M1_CU_CMP_Simulation/Simul_ED2_{product}.csv')

        Simul_Other = Simul_Z5
        Simul_Other.to_csv(f'/project/day/workSpace/mico-platform/mico-platform-mainvs/pjt_shared_pool/{product}_M1_CU_CMP_Simulation/Simul_Other_{product}.csv')
